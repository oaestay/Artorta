...
ActiveRecord::Schema.define(version: 2020_04_21_003225) do
  ...
  create_table "presses", id: :serial, force: :cascade do |t|
    t.string "name"
    t.integer "popularity", default: 0
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "wedding_toppings", id: :serial, force: :cascade do |t|
    t.string "name"
    t.string "code"
    t.integer "popularity", default: 0
    t.datetime "created_at", null: false
