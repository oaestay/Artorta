...
ActiveRecord::Schema.define(version: 20161003043851) do
  ...
  add_index "prices", ["cake_id"], name: "index_prices_on_cake_id", using: :btree
  ...
  create_table "wedding_toppings", force: :cascade do |t|
    t.string   "name"
    t.string   "code"
    t.integer  "popularity",         default: 0
    t.datetime "created_at",                     null: false
